...
WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Swag Labs/div_Sauce Labs Onesie'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Swag Labs/div_Rib snap infant onesie for the junior a_cb3bbc'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Swag Labs/div_7.99'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Swag Labs/div_1'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Swag Labs/button_Remove'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Swag Labs/button_Checkout'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Swag Labs/button_Continue Shopping'))
